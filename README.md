...
**Observação:** Cada usuário só pode consultar e manipular seus próprios dados e transações após validado, através de um **token de autenticação.**

## **Banco de dados**

Os dados são armazenados no banco de dados PostgreSQL. Abaixo detalhamento da estrutura do banco de dados:
...
**Dump.sql:** Este arquivo possui o script de criação do banco de dados e suas entidades.

Para realizar testes na API As categorias a seguir devem ser previamente cadastradas.
